...
ConnectionLight.prototype.subscribe = function(driver){
	this.drivers.push(driver);
};

ConnectionLight.prototype.unsubscribe = function(driver){
...
ConnectionLight.prototype.notify = function()
{
	var args = Array.prototype.slice.call(arguments, 0);
	for(var i =0; i < this.drivers.length; i++)
	{
		this.drivers[i].updateLight.apply(null, args);
	}
};

module.exports = new ConnectionLight;
